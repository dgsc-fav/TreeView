 ...
 */
abstract class BaseNodeViewFactory<V, C> {
    /**
     ...
     * @return
     */
    fun getViewType(treeNode: TreeNode<V, C>): Int {
     ...
     */
    abstract fun getNodeViewBinder(view: View, viewType: Int): BaseNodeViewBinder<V, C>?
